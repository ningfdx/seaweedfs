...
func NewChunkGroup(lookupFn wdclient.LookupFileIdFunctionType, chunkCache chunk_cache.ChunkCache, chunks []*filer_pb.FileChunk, concurrentLimit int) (*ChunkGroup, error) {
	group := &ChunkGroup{
		lookupFn:    lookupFn,
		chunkCache:  chunkCache,
		sections:    make(map[SectionIndex]*FileChunkSection),
		readerCache: NewReaderCache(concurrentLimit, chunkCache, lookupFn),
	}
